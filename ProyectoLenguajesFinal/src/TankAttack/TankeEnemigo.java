...
import javax.swing.*;
    ...
    public class TankeEnemigo {
    TankeEnemigo(int inicialX, int inicialY){
    ...
    protected ImageIcon ImagenEnemigo = new ImageIcon("src/Imagenes/tankRDer.png");

    protected void turnLeft(){
        if (arriba){
            arriba = false;
            izquierda = true;
            ImagenEnemigo = new ImageIcon("src/Imagenes/tankRIzq.png");
        }

        if (izquierda){
            izquierda = false;
            abajo = true;
            ImagenEnemigo = new ImageIcon("src/Imagenes/tankRAbj.png");
        }

        if (abajo){
            abajo = false;
            derecha = true;
            ImagenEnemigo = new ImageIcon("src/Imagenes/tankRDer.png");
        }

        if (derecha){
            derecha = false;
            arriba = true;
            ImagenEnemigo = new ImageIcon("src/Imagenes/tankRArriba.png");
        }
    }
